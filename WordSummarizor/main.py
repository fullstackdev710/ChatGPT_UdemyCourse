...
def summarize_text(file_location):
    ...
    summarize_text = response["choices"][0]["text"]
...
header = tk.Label(root, text="Text Summarizer", bg="white", font=header_font)
header.pack(pady=20)
...
browse_button = tk.Button(root, text="Browse", command =browse_file, bg="#4267B2", fg="black",relief="flat",borderwidth=0,activebackground="#4267B2", activeforeground="white")
browse_button.config(font=("Arial",12,"bold"),width=10,height=2)
browse_button.pack()
text_field=tk.Text(root, height=20,width=50,bg="white",fg="black",relief="flat",borderwidth=0)
text_field.pack()
root.mainloop()